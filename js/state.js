...
export function sanitizeState(s) {
  // very defensive: keep kid safe from broken JSON
  ...
  out.koala.color = String(k.color || "lavender");
  ...
  out.wardrobe.equipped = (w.equipped && typeof w.equipped === "object") ? w.equipped : d.wardrobe.equipped;
